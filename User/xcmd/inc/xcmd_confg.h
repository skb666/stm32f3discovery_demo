...
#define XCMD_LINE_MAX_LENGTH (512)         /* 命令行支持的最大字符数 */
#define XCMD_HISTORY_MAX_NUM (4)           /* 支持的历史记录个数, 这个参数对内存的影响很大，建议arduino设置为0，0为不支持 */
#define XCMD_PARAM_MAX_NUM (64)            /* 支持输入的参数个数 */
#define XCMD_DEFAULT_PROMPT ">>> "         /* 提示符 */
#define XCMD_DEFAULT_PROMPT_CLOLR TX_WHITE /* 提示符颜色 */
#define XCMD_USING_EXTENSIONS              /* 启用扩展命令与按键 */
